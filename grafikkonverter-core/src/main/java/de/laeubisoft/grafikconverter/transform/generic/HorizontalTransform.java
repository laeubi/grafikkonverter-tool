...
public class HorizontalTransform implements LinearTransform {
    ...
    public String getName() {
        return "Horizontale Ausgabe";
    }

    @Override
    public String getDescription() {
        return "Gibt das Bild von Links nach Rechts und von Oben nach Unten aus";
    }
